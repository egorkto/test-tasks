...
<p style="display:inline" class="float">
	<img src="https://www.calend.ru/img/content_events/i0/961.jpg" alt="Волгоград" width="300" height="200" itemprop="image">
	<span class="caption gray">Скульптура «Родина-мать зовет!» входит в число семи чудес России (Фото:</span><a href="#" id="reveal-link">...</a></p>
TXT;

$second_part = <<<TXT
<p style="display:inline"><span> Art Konovalov, по лицензии shutterstock.com)</span>
</p>
<p>
...
<body>
    <?= $first_part ?>
    <div id="second-part"><?= $second_part ?></div>
